...
int main(){
    ...
    points.push_back(std::complex<double>(1.0, -4.0));
    points.push_back(std::complex<double>(3.0, 2.0));
    points.push_back(std::complex<double>(7.1, 7.0));

    std::cout << "The first real part: " << points.begin()->real() << std::endl;
    std::cout << "Imaginaray part at index 1: " << points[1].imag() << std::endl;
